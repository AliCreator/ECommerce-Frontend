...
const HeroCategory = () => {
  return (
    <div className="w-full flex flex-col md:flex-row items-center justify-between  h-[70vh] md:h-[55vh] lg:h-[50vh] bg-white dark:bg-slate-950 my-1">
      ...
      <div className="basis-1/3   flex flex-col md:justify-center gap-5 md:gap-4 p-5 md:p-8 order-2 md:order-1 bg-red-50 dark:bg-slate-950  h-full w-full">
