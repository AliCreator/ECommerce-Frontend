...
const ProductCard = ({image, price, description, discount}) => {
  return (
    <Link to="/p/22" className='flex flex-col gap-3 p-2 min-w-[10rem] max-w-[12rem] md:min-w-[12rem] md:max-w-[15rem] min-h-[10rem] border border-slate-600 rounded-md bg-white pb-5'>
