...
const StarPercentage = ({ star, percentage }) => {
  return (
    <div className="flex w-full items-center gap-1">
      <p className="basis-1/6 text-gray-600 dark:text-gray-200 text-sm">{star} stars</p>
      ...
      <p className="basis-1/6 text-gray-600 dark:text-gray-200 text-sm">{percentage}%</p>
    </div>
  );
};
